package ru.itvitality.sbrf.cu.l05.example;

import ru.itvitality.sbrf.cu.l05.example.services.ClosedConsoleIOService;
import ru.itvitality.sbrf.cu.l05.example.services.ConsoleContext;
import ru.itvitality.sbrf.cu.l05.example.services.IOService;
import ru.itvitality.sbrf.cu.l05.example.services.OpenedConsoleIOService;
