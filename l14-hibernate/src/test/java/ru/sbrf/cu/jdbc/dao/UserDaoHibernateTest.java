package ru.sbrf.cu.jdbc.dao;

import org.assertj.core.api.Assertions;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.DisplayName;
import org.junit.jupiter.api.Test;
import ru.sbrf.cu.AbstractHibernateTest;
...
class UserDaoHibernateTest extends AbstractHibernateTest {
  ...
  void getSessionManager() {
    Assertions.assertThat(userDaoHibernate.getSessionManager()).isNotNull().isEqualTo(sessionManagerHibernate);
  }
